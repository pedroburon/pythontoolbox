# encoding=UTF-8
# Django settings for pythontoolbox project.
import os
...
SECRET_KEY = '-@fw8@p$g9(0xp-qy#*h471(z3m7o*@(t+g02pt)78f%r-wv&amp;n'
...
ROOT_URLCONF = 'pythontoolbox.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'pythontoolbox.wsgi.application'
